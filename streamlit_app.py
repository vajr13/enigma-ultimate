...
# Proses enkripsi lengkap dengan log
def enigma_process_with_log(message, rotor1, rotor2, rotor3, rotor_pos1, rotor_pos2, rotor_pos3, plugboard):
    processed_message = ""
    log = []
...
# Proses enkripsi
if message:
    processed_message, log = enigma_process_with_log(message, rotor_1, rotor_2, rotor_3, rotor_pos1, rotor_pos2, rotor_pos3, st.session_state.plugboard)
